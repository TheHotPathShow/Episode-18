...
(_ name: (identifier) @variable.local)
(_ expression: (identifier) @type)
...
(field_declaration (variable_declaration (variable_declarator name: (identifier) @variable.local)))
(foreach_statement left: (identifier) @variable.local)
(attribute name: (identifier) (attribute_argument_list (attribute_argument (member_access_expression name: (identifier) @variable.parameter))))
